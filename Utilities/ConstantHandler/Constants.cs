namespace Common.ConstantHandler
{
    public class Constants
    {
        ...
        public const string NOTIFICATION_VIEW = "_NotificationDropdownPartial";
        ...
        public const string AUTHORIZATION_COMPLETE_FILE = "AuthorizationComplete.html";
        ...
        #endregion
        public const string LOGIN_REQUEST = "Login Request";
        public const string REGISTER_REQUEST = "Register Request";
        public const string RESET_PASSWORD_LINK_REQUEST = "Reset Password Link Request";
        public const string UPDATE_PASSWORD_REQUEST = "Update Password Request";
